...
3. **Answer at the stones.** Three slabs rise with a question written for your sparks. Tap one.
...
5. **Look around.** Every lantern in the arc behind each board is someone's answer. The fire's size is the count of every answer ever given. The pillar shows today's question and each board carries a stamp such as "23 answers · latest today".
...
| Social Value | Named cross-time matching: "You and Amara both said…" is a real visitor, present or past, so a solo judge still meets someone |
...
- **Nobody else online:** expected and designed for. Matching works against everyone who has ever answered, and the server seeds founding entries on first boot, so the reveal always names someone.
